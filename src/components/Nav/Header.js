          ...
          <SearchInputDesktop>
            <SearchInputDesktopForm>
              ...
              <SearchRelated>
                <SearchResultUl>
                  <SearchResultLi>
                    <SearchResultLiKeyword>첫 번째 검색어</SearchResultLiKeyword>
                  </SearchResultLi>
                </SearchResultUl>
              </SearchRelated>
              {/* 검색 아이콘 */}
          ...
          <UiGnbUl>
            <UiGnbMenuLi>
              ...
              >
                <CategorySubmenuUl>
                  <CategorySubmenuLi>
                    <CategorySubmenuA>남녀공용</CategorySubmenuA>
                  </CategorySubmenuLi>

                  <CategorySubmenuLi>
                    <CategorySubmenuA>여성용</CategorySubmenuA>
                  </CategorySubmenuLi>

                  <CategorySubmenuLi>
                    <CategorySubmenuA>남성용</CategorySubmenuA>
