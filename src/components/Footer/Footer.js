    ...
    <FooterTag>
      <FullW>
        <NavLinks>
          ...
          <span>|</span>
          <MShow to="/test">About PERFUME</MShow>
        </NavLinks>
      </FullW>
      <InnerWClf>
        <LogoFooter>{/* <LogoGray /> */}</LogoFooter>
        <Fl>
          <FooterStrong>(주) 퍼퓸</FooterStrong>
          <FooterUl>
            <FooterLi>대표이사 : 김지효</FooterLi>
            {/* <FooterLi>서울특별시 성북구 삼선교로16길 116</FooterLi>
            <FooterLi>사업자 등록번호 : ***-**-*****</FooterLi>
            <FooterLi>통신판매업신고 : 2024-서울성북-****</FooterLi> */}
          </FooterUl>
          <NtFix1>
            퍼퓸은 통신판매중개자이며 통신판매의 당사자가 아닙니다.
            <br />
            따라서 퍼퓸은 상품 거래정보 및 거래에 대하여 책임을 지지
            않습니다.
            <Copyright>Copyright © 2024 PERFUME All right reserved.</Copyright>
          </NtFix1>
        </Fl>
        <Fl>
