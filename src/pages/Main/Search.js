    ...
    if (checked === "가격대 전체") {
      if (priceChecked === "1만5천원이하") {
        ...
        const result = await axios.get(
          "https://backend.alittlevanilla.kro.kr/product/search?word=" +
            params.word +
            "&gte=0&lte=15000"
        );
                        ...
                        <DesktopRadioFilterRowItem>
                          <FilterItem>
                            <CheckBox>
                              ...
                              <CheckBoxLabel>15,000원~30,000원</CheckBoxLabel>
                            </CheckBox>
                          </FilterItem>
                        </DesktopRadioFilterRowItem>
                      </DesktopRadioFilterRowBody>
                        ...
                        <DesktopRadioFilterRowItem>
                          <FilterItem>
                            <CheckBox>
                              ...
                              <CheckBoxLabel>15,000원 이하</CheckBoxLabel>
                            </CheckBox>
                          </FilterItem>
                        </DesktopRadioFilterRowItem>
                ...
                <DesktopProductFilterBottom>
                  <OnlyImgBtn type="button">
                    <OnlyImgBox>
                      ...
                      <OnlyImgMarginL>이미지만 보기</OnlyImgMarginL>
                    </OnlyImgBox>
                  </OnlyImgBtn>
